...
function(system_to_string)
  ...
  set(${STRING_STRING} "define exported symbol _link_file_version_2 = 1;\n")
...
function(section_to_string)
  ...
  if("${name_clean}" STREQUAL "data")
    set(TEMP "${TEMP}, static base GPREL ")
  endif()
  ...
  if(DEFINED group_parent_vma AND DEFINED group_parent_lma)
    if(DEFINED current_sections)
      ...
      string(REGEX REPLACE ", static base GPREL" "" INIT_TEMP "${INIT_TEMP}")
...
if(DEFINED STEERING_FILE)
  ...
  file(APPEND ${STEERING_FILE} "--redirect __iar_static_base$$GPREL=__global_pointer$\n")
