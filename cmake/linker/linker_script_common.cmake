include(${CMAKE_CURRENT_LIST_DIR}/../modules/kconfig_extensions.cmake)
...
# Start by loading the extra inputs
foreach(file ${INCLUDES})
  if("${file}" MATCHES "^{(.*)}$")
    # KCONFIG is a single arg thing here since the other cmake machinery always
    # passes a single argument (TRUE or FALSE)
    cmake_parse_arguments(INC "" "KCONFIG;FILE" "PASS" ${CMAKE_MATCH_1})
    ...
    message("Reading file ${INC_FILE}")
    if(INC_KCONFIG)
      import_kconfig(CONFIG ${INC_FILE})
...
# the syntax @FOO@ where FOO is a cmake variable name, currently this is done
# by sifting through the .h header files generated by
# e.g. zephyr/scripts/build/gen_kobject_placeholders.py, or by direct
# variables from zephyr_linker_include_var()
