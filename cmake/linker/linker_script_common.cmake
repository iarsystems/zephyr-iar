...
function(create_region)
  ...
  message(STATUS "create_region(${OBJECT_NAME})")
...
function(create_group)
  ...
  message(STATUS "create_group(${OBJECT_NAME},parent=${OBJECT_GROUP}")
  ...
  if(DEFINED OBJECT_GROUP)
    ...
    if(DEFINED OBJECT_LMA)
      set_property(GLOBAL PROPERTY GROUP_${OBJECT_NAME}_LMA ${OBJECT_LMA})
      find_object(OBJECT parent NAME ${OBJECT_LMA})
    endif()
    if(DEFINED OBJECT_VMA)
      set_property(GLOBAL PROPERTY GROUP_${OBJECT_NAME}_VMA ${OBJECT_VMA})
      find_object(OBJECT parent NAME ${OBJECT_VMA})
    endif()
  endif()
...
function(copy_section from_name to_name)
  message(STATUS "copy_section(${from_name} ${to_name}")

  set_property(GLOBAL PROPERTY ${to_name} TRUE)

  set(properties "NAME;NAME_CLEAN;OBJ_TYPE;ADDRESS;TYPE;ALIGN;ALIGN_WITH_INPUT;SUBALIGN;ENDALIGN;NOINPUT;NOINIT;NOSYMBOLS;MIN_SIZE;MAX_SIZE;PARENT;VMA;LMA;GROUP")
  foreach(property ${properties})
    get_property(setting_value GLOBAL PROPERTY ${from_name}_${property})
    set_property(GLOBAL PROPERTY ${to_name}_${property}   ${setting_value})
  endforeach()


  set_property(GLOBAL PROPERTY ${to_name}_NAME_CLEAN       ${name_clean})
  ...
  get_property(indicies GLOBAL PROPERTY ${from_name}_SETTINGS_INDICIES)
  set_property(GLOBAL PROPERTY ${to_name}_SETTINGS_INDICIES ${indicies})
  foreach(idx ${indicies})
    foreach(setting ${settings_single} ${settings_multi})
      set(setting_value)
      get_property(setting_value GLOBAL PROPERTY ${from_name}_SETTING_${idx}_${setting})
      set_property(GLOBAL PROPERTY ${to_name}_SETTING_${idx}_${setting} ${setting_value})
    endforeach()
  endforeach()

  get_property(name GLOBAL PROPERTY ${to_name}_NAME)
  get_property(address GLOBAL PROPERTY ${to_name}_ADDRESS)
  get_property(vma GLOBAL PROPERTY ${to_name}_VMA)
  # add_section(OBJECT ${parent} SECTION ${name} ADDRESS ${address} VMA ${vma})
...
function(add_group)
  ...
  message(STATUS "add_group(OBJECT ${ADD_GROUP_OBJECT} GROUP ${ADD_GROUP_GROUP}")
  ...
  message(STATUS "APPEND ${ADD_GROUP_OBJECT}_GROUPS ${ADD_GROUP_GROUP})")
  set_property(GLOBAL APPEND PROPERTY ${ADD_GROUP_OBJECT}_GROUPS ${ADD_GROUP_GROUP})
  #message(STATUS "APPEND ${ADD_GROUP_OBJECT}_${vma}_GROUPS ${ADD_GROUP_GROUP})")
...
function(is_empty)
  ...
  message(STATUS "is_empty(${IS_EMPTY_OBJECT}) = ...")
...
function(process_region_common)
  ...
  message(STATUS "process_region_common(${REGION_COMMON_OBJECT})")
  ...
  foreach(region ${regions})
    get_property(vma GLOBAL PROPERTY ${region}_NAME)
    message(STATUS "region: ${region}, vma: ${vma}")
    set(sections_${vma})
    ...
    list(APPEND sections_${vma} ${sections})
    message(STATUS "sections_${vma}: ${sections_${vma}}")
