...
zephyr_linker(FORMAT "elf32-littleriscv")
zephyr_linker(ENTRY ${CONFIG_KERNEL_ENTRY})

dt_chosen(zephyr_flash PROPERTY "zephyr,spi-nor")
...
if(CONFIG_RISCV_GP)
  zephyr_linker_symbol(SYMBOL __global_pointer$ EXPR "(@__data_start@ + 0x800)")
endif()
